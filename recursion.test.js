...
describe("balanced brackets", function () {
	it("determine if a string is balanced in its brackets", function() {
		expect(balancedBrackets('(a{b}cdefg)')).toBe(true);
		expect(balancedBrackets('(a{b}cdefg))')).toBe(false);
		expect(balancedBrackets('](a{b}cdefg)')).toBe(false);
		expect(balancedBrackets('((')).toBe(false);
		expect(balancedBrackets('(a{bc(d)}efg)')).toBe(true);
	});
});